...
app.use('/', indexRouter);    // public homepage
app.use('/users', usersRouter); // protected user routes
app.use('/getJotFormData', ensureAuthenticated, getJotFormData); // protected route
...
app.use((err, req, res, next) => {
    ...
    res.render('index'); // make sure views/error.hbs exists
});
